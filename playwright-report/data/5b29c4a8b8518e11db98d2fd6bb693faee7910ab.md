...
- Name: payment-flows.spec.ts >> Researcher Payment Flow >> should allow researcher to view wallet and add funds
- Location: e2e/payment-flows.spec.ts:4:3
...
Locator: getByRole('heading', { name: /Cüzdan & Bakiye/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /Cüzdan & Bakiye/i })

```

```yaml
- heading "Moleculer DePIN" [level=1]
- paragraph: Merkeziyetsiz moleküler araştırma platformuna hoş geldiniz.
- text: Hesabınıza Giriş Yapın Devam etmek için e-posta ve şifrenizi girin E-posta
- textbox "E-posta":
